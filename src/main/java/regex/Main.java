...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // Regex pattern: positive lookaheads for lowercase, uppercase, digit, then minimum length
    ...
    public static List<String> extractEmails(String str) {
        ...
        // Regex pattern: one or more non-whitespace characters (email local part), then @, then optionally "mail.", then "utoronto.ca"
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Regex pattern: matches entire string if it contains the same capital letter twice
        // ([A-Z]) captures a capital letter, .*\1.* ensures it appears again later
